            ...
            <div class="col-md-15 contentb-grey1">
                <div class="content2">
                    <a href="#">
                        ...
                        </span>Whatsapp. <?php echo $this->setting['contact_wa'] ?></p>
                    </a>
                </div>
            </div>
            <div class="col-md-15 contentb-grey2">
                <div class="content3">
                    <a href="#">
                        ...
                        </span>Telephone. <?php echo $this->setting['contact_phone'] ?></p>
                    </a>
                </div>
            </div>
            <div class="col-md-15 contentb-grey1">
                <div class="content4">
                    <a href="#">
                        ...
                        </span>Email. <?php echo $this->setting['email'] ?></p>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row ">
            <div class="col-md-60 mx-auto">
                <div class="copyright mx-auto text-center d-block">
                    <p>Copyright &copy; PT. Arsimetris Djaja - Banjarmasin, Kalimantan Selatan. Website design by <a href="https://www.markdesign.net/">
